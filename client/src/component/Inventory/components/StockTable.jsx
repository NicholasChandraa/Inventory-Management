          ...
          {currentItems.length > 0 ? (
            currentItems.map((item, index) => (
              ...
              >
                <td>
                  <Link
                    to={`/product/ProductDetailPage/${item.product._id}`}
                    className="px-5 py-3 text-blue-500 hover:text-blue-800"
                  >
                    {`ID-${item._id.slice(-8)}`}
                  </Link>
                </td>
                ...
                <td className="px-3 py-2 text-sm text-gray-900">
                  {editRowId === item._id ? (
                    <button
                      ...
                      className="text-white bg-blue-500 hover:bg-blue-700 font-medium rounded-lg text-sm px-4 w-16 py-2 text-center"
                    >
                      Save
                    </button>
                  ) : (
