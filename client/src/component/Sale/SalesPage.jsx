  ...
  return (
    <>
      ...
      <div className="p-6 md:p-8 lg:p-10">
        <h2 className="text-xl md:text-2xl font-medium">DAFTAR PENJUALAN</h2>
        <div className="border-b-2 my-4 md:my-6 mb-6 md:mb-8"></div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr>
                <th className="px-2 py-3 bg-gray-800 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider rounded-tl-md">
                  No. Pesanan
                </th>
                <th className="px-2 py-3 bg-gray-800 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">
                  Tanggal Jual
                </th>
                <th className="px-2 py-3 bg-gray-800 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">
                  Pelanggan
                ...
                <th className="px-2 py-3 bg-gray-800 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider rounded-tr-md">
                  Hapus
                </th>
              </tr>
            </thead>
            <tbody>
              {sales.map((sale) => (
                <tr key={sale._id}>
                  ...
                  <td className="text-start py-2 px-3 border">
                    {`${sale.customer.address.street}, ${sale.customer.address.city}, ${sale.customer.address.state}, ${sale.customer.address.zipCode}`}
                  </td>
                  <td className="text-start py-2 px-3 border">
      ...
      >
        <ModalBody>
          <p className="text-lg font-semibold text-center">
            Yakin ingin menghapus data penjualan?
          </p>
        </ModalBody>
      ...
      >
        <ModalBody>
          <p className="text-lg font-semibold text-center">
            Yakin ingin mengubah data pembayaran?
          </p>
        </ModalBody>
        <ModalFooter className="justify-center">
          <Button
